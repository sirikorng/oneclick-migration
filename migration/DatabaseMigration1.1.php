...
require_once('dupx/class.dupx.wpconfig1.1.php');
...
LOG;
    ...
    public function updateWPConfig($root_path, $url_new, $retain_config, $dbh, $web_config, $database_connection_config) {
        //===============================================
        ...
        DUPX_Log::info("====================================\n");
        DUPX_WPConfig::updateStandard($database_connection_config);
        $config_file = DUPX_WPConfig::updateExtended($web_config);
