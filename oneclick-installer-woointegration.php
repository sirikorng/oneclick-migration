...
if(is_resource($dbh) && get_resource_type($dbh)==='mysql link'){
    ...
    $dbh = $db_mgr->writeSQLData($_POST['dbhost'], $_POST['dbuser'], $_POST['dbpass'], $_POST['dbname'], $_POST['dbport'], $dbh, $scan_result, $_POST['dbcharset'], $_POST['dbcollate']);
   ...
   // $db_mgr->connectDatabase($dbh, $database_connection_config, $database_config);   
    $dbh = $db_mgr->connectDatabase($_POST['dbhost'], $_POST['dbuser'], $_POST['dbpass'], $_POST['dbname'], $_POST['dbport'], $_POST['dbcharset'], $_POST['dbcollate']);
